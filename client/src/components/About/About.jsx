...
const About = () => {
  return (
    <div className={style.about}>
      ...
      <div>
        <h1 className={style.title2}>Mis habilidades</h1>
      </div>
          ...
          <div className={style.habilitiesContainer}>
            <div className={style.flex}>
              ...
              <div>
                ...
                Con mis habilidades en React.js, que incluyen el uso de Redux, puedo desarrollar aplicaciones webs de alta calidad y funcionalidad.
                </p>
              </div>
            </div>
          </div>
          <div className={style.habilitiesContainer}>
            <div className={style.flex}>
              ...
              <div>
                ...
                <p className={style.paramHabilities}>
                Cuento con experiencia en el uso de Node junto a Express, lo cual me permite manejar información relevante de manera efectiva.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className={style.habilitiesContainer}>
            <div className={style.flex}>
              ...
              <div>
                ...
                <p className={style.paramHabilities}>
                Cuento con experiencia en el uso de CSS, incluyendo el uso de Flexbox, Grid y Media Queries, lo cual me permite crear diseños atractivos y responsivos.
                </p>
              </div>
            </div>
          </div>
